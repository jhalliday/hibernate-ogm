...
public interface Log extends org.hibernate.ogm.util.impl.Log {
	...
	@Message(id = 2001, value = "Connecting to Cassandra at %1$s:%2$d")
	void connectingToCassandra(String host, int port);

	@LogMessage(level = INFO)
	@Message(id = 2002, value = "Closing connection to Cassandra")
	void disconnectingFromCassandra();

	@Message(id = 2003, value = "Unable to initialize Cassandra driver")
